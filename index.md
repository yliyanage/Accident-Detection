...
* Possible extensions:
  1. In this study, we consider binary classification of accidents. Instead, can be extended to detect the level of severity once an accident occurs.
...
## Acknowledgements
We would like to thank [Dr. Hany Elgala](https://www.albany.edu/~HE895353/), [Monette Khadr](https://www.albany.edu/~HE895353/monette.html) for their valuable comments and [Dr. Daphney-Stavroula Zois](https://www.albany.edu/~dz973423/) for granting access to real-time speed data provided by the California Department of Transportation.
